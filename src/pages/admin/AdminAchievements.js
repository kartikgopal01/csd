...
const AdminAchievements = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    description: '',
    date: '',
    achievementType: 'STUDENTS', // Default to STUDENTS
    studentName: '',
    facultyName: '',
    imageBase64: '',
  });
  ...
  const handleEdit = (achievement) => {
    ...
    setFormData({
      ...
      achievementType: achievement.achievementType || 'STUDENTS',
      studentName: achievement.studentName || '',
      facultyName: achievement.facultyName || '',
      imageBase64: achievement.imageBase64 || '',
    });
    setShowForm(true);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error('Error saving achievement. Please try again.');
    }
  };
  ...
  const filteredAchievements = achievements.filter(achievement => {
    return !searchTerm || 
      (achievement.title && achievement.title.toLowerCase().includes(searchTerm.toLowerCase())) ||
      (achievement.studentName && achievement.studentName.toLowerCase().includes(searchTerm.toLowerCase())) ||
      (achievement.facultyName && achievement.facultyName.toLowerCase().includes(searchTerm.toLowerCase()));
  });
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2" htmlFor="achievementType">
                  Achievement Type
                </label>
                <select
                  id="achievementType"
              ...
              {formData.achievementType === 'STUDENTS' ? (
                <div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search achievements by title or name"
              />
            </div>
          </div>
                    ...
                    <tr key={achievement.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                          {achievement.achievementType === 'STUDENTS' ? achievement.studentName : achievement.facultyName}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
